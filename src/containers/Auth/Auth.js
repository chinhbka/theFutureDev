...
import imgLogin from "../../assets/images/login/imgLogin.png";

const useStyles = makeStyles((theme) => ({
  container: {
    minHeight: "100vh",
    background: "linear-gradient(120deg, #e6f4ff, #e6f4ff)",
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${imgLogin})`,
  ...
  logbtn: {
    ...
    border: "none",
    borderRadius: "3px",
    background: "linear-gradient(120deg, #4d7dc4, #4d7dc4)",
    backgroundSize: "200%",
    color: "#fff",
    outline: "none",
    transition: "0.5s",
